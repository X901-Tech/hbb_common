...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("RustDeskRED".to_owned());
...
// RustDesk-RED: hardcoded to private server
pub const RENDEZVOUS_SERVERS: &[&str] = &["remote.wav.global"];
pub const RS_PUB_KEY: &str = "klyF4Gc83JH6EXXtdNzVt2YhVFzA1kNgsM8zI4qxJIM=";
